================================================================================
  SUPERCALC — README
  Super Calculator | Álgebra Lineal + Física
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  currentParent   --->  current Parent module (módulo padre activo: al / fi)  ! Variable de estado
  ...
  matOpsState     --->  MATrix OPerations State (estado completo de operaciones)! Variable de estado
  ...
  fN              --->  Format Number (formatea número con fracciones o dec.) ! Función utilitaria
  ...
  ineqLinearBound --->  INEQuality LINEAR BOUND (límite de inecuación lineal) ! Función matemática
  ...
  ineqSolveAbs    --->  INEQuality SOLVE ABSolute value (resuelve |ax+b|⊳c)  ! Función cálculo
  ...
  launchSubmod    --->  LAUNCH SUBMODule (abre módulo específico del submenú)! Función navegación
  ...
  pLin            --->  Print LINear (renderiza resultado de ecuación lineal) ! Función UI
  ...
  showTab         --->  SHOW TAB (muestra tab seleccionado en panel AL)      ! Función UI
  ...
  uV              --->  Update Vector (actualiza componente de vector por ID) ! Función UI
